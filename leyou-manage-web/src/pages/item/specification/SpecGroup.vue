      ...
      <template slot="items" slot-scope="props">
        <tr @click="selectGroup(props.item)">
          ...
          <td class="justify-center layout px-0">
            <v-btn icon @click.stop="editGroup(this.props.item)"><i class="el-icon-edit"/> </v-btn>
            <v-btn icon @click.stop="deleteGroup(this.props.item.id)"><i class="el-icon-delete"/> </v-btn>
          </td>
        </tr>
      </template>
    </v-data-table>
